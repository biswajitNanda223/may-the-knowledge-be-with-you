...
export function ChatPage() {
  const [question, setQuestion] = useState(
    "Which business rules govern a project?",
  );
  ...
  const animatedPaths = useMemo(
    () => evidenceRoutes.map((route) => route.elements),
    [evidenceRoutes],
  );
  ...
  const toggleEvidenceSize = () =>
    setEvidenceMode((value) => (value === "expanded" ? "normal" : "expanded"));
    ...
    <main className="chat-workspace">
      <section className="chat-surface">
        <div className="chat-heading">
          ...
          >
            Sources <b>{nodes.length}</b>
          </button>
        </div>
        <div
          className={`conversation ${answer ? "has-answer" : ""}`}
          aria-live="polite"
        >
          {answer || busy ? (
            ...
            <div className="drawer-head">
              ...
              <div className="drawer-actions">
                <button
                  ...
                  title="Minimize"
                  onClick={() => setEvidenceMode("minimized")}
                ...
                <button
                  ...
                  className="icon-button"
                  title={
                    evidenceMode === "expanded" ? "Restore size" : "Expand"
                  }
                  onClick={toggleEvidenceSize}
                  aria-label={
                    evidenceMode === "expanded"
                      ? "Restore sources size"
                      : "Expand sources"
                  }
                >
                  <Icon name="maximize" />
