  ...
  await app.register(swagger, {
    openapi: {
      ...
      info: {
        ...
        description: 'Fastify API for ontology ingestion, paginated Neo4j exploration, ADK chat evidence, and ADK-only telemetry.',
        version: '1.0.0'
      },
      tags: [
        ...
        { name: 'Ingestion', description: 'Normalized ontology source ingestion' },
